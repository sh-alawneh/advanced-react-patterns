...
class Toggle extends React.Component {
  ...
  internalSetState = (changes, callback) => {
    ...
    const ch = typeof changes === 'function' ? changes(this.state) : changes;
    const userChanges = this.props.stateReducer(this.state, ch);
    const updater = Object.keys(userChanges).length ? userChanges : null;
